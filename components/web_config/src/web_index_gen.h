...
const BOARD_OUTPUT_PROFILES = {
  board_v2: {
    ...
    outputs: [
      { id: 'M1', display_name: 'Motor 1 / P1', kind: 'motor', runtimeControlled: true, detail: 'DRV8871 brushed DC output. GPIO0 = IN1, GPIO1 = IN2.' },
      { id: 'M2', display_name: 'Motor 2 / P2', kind: 'motor', runtimeControlled: true, detail: 'DRV8871 brushed DC output. GPIO21/TXD0 = IN1, GPIO10 = IN2.' },
